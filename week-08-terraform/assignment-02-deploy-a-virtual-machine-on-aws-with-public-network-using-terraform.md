...
![aws-version](/week-08-terraform/screenshots/Assign2-SS-1.png)
...
![aws-provider](/week-08-terraform/screenshots/Assign2-SS-2.png)
...
![ec2-instance](/week-08-terraform/screenshots/Assign2-SS-3.png)
...
![init-success](/week-08-terraform/screenshots/Assign2-SS-4.png)
...
![terraform-plan](/week-08-terraform/screenshots/Assign2-SS-5.png)

---

#### Screenshot 6 — Terraform apply output showing successful completion

![apply-success](/week-08-terraform/screenshots/Assign2-SS-6.png)

---

#### Screenshot 7 — Terraform output showing the public IP address of the EC2 instance

![public-ip](/week-08-terraform/screenshots/Assign2-SS-7.png)
...
**EC2 Public IP Address:** '32.197.191.178'
...
![ec2-running-state](/week-08-terraform/screenshots/Assign2-SS-8.png)

---

#### Screenshot 9 — Browser showing the Nginx page successfully loaded using the EC2 instance public IP

![ec2-instance-public-ip](/week-08-terraform/screenshots/Assign2-SS-9.png)
...
![terraform-destroy](/week-08-terraform/screenshots/Assign2-SS-10.png)
