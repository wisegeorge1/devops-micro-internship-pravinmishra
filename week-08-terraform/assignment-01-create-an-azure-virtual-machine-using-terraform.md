...
![terraform-version](/week-08-terraform/screenshots/Assign1-SS-1.png)

---

#### Screenshot 2 — Terminal showing successful `az version` output

![az-version](/week-08-terraform/screenshots/Assign1-SS-2.png)

---

#### Screenshot 3 — VS Code Extensions panel showing the HashiCorp Terraform extension installed and enabled

![vscode-extension](/week-08-terraform/screenshots/Assign1-SS-3.png)
...
![azureRM](/week-08-terraform/screenshots/Assign1-SS-4.png)
...
![vm-output-block](/week-08-terraform/screenshots/Assign1-SS-5.png)
...
![terraform-output](/week-08-terraform/screenshots/Assign1-SS-6.png)
...
![t-plan-summary](/week-08-terraform/screenshots/Assign1-SS-7.png)

---

#### Screenshot 8 — Terraform apply output showing successful completion

![terraform-success](/week-08-terraform/screenshots/Assign1-SS-8.png)

---

#### Screenshot 9 — Terraform output showing the public IP address of the VM

![terraform-output](/week-08-terraform/screenshots/Assign1-SS-9.png)

### Question

VM Public IP Address: [20.235.21.141]
...
![cli-output](/week-08-terraform/screenshots/Assign1-SS-10.png)
...
![terraform-destroy](/week-08-terraform/screenshots/Assign1-SS-11.png)
